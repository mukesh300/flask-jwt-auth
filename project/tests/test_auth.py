...
class TestAuthBlueprint(BaseTestCase):
    ...
    def test_registration(self):
        ...
        with self.client:
            response = register_user(self, 'raj@gmail.com', '123456')
    ...
    def test_registered_user_login(self):
        ...
        with self.client:
            # user registration
            resp_register = register_user(self, 'raj@gmail.com', '123456')
            ...
            response = login_user(self, 'raj@gmail.com', '123456')
    ...
    def test_user_status(self):
        ...
        with self.client:
            ...
            self.assertTrue(data['data']['email'] == 'raj@gmail.com')
    ...
    def test_valid_logout(self):
        ...
        with self.client:
            ...
            self.assertEqual(resp_register.status_code, 201)
            # user login
            resp_login = login_user(self, 'raj@gmail.com', '123456')
